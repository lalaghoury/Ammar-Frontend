...
import App_Store_Badge_Svg from "../../assets/images/app-store-badge.svg";
import Goolge_Play_Badge_Svg from "../../assets/images/google-play-badge.svg";
...
const items = [
  {
    key: "1",
    label: <h1>Popular Categories</h1>,
    children: <p>{text}</p>,
  },
];
